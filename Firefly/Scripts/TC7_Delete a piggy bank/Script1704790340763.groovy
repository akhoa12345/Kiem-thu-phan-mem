...
WebUI.click(findTestObject('Object Repository/Page_Piggy banks  Firefly III/a_btn btn-danger btn-xs'))

WebUI.click(findTestObject('Object Repository/Page_Delete piggy bank Flower  Piggy banks _694390/input_submit'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Piggy banks  Firefly III/div_Close                Success           _c387ea'), 
    0)
