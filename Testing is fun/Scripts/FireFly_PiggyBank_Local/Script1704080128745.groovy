...
WebUI.setText(findTestObject('Object Repository/Page_New piggy bank  Piggy banks  Firefly III/input_name'), 'Flower')

WebUI.setText(findTestObject('Object Repository/Page_New piggy bank  Piggy banks  Firefly III/input_targetamount'), '500')

WebUI.setText(findTestObject('Object Repository/Page_New piggy bank  Piggy banks  Firefly III/textarea_notes'), 'Buy flower')

WebUI.click(findTestObject('Object Repository/Page_New piggy bank  Piggy banks  Firefly III/button_Store new piggy bank'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Piggy banks  Firefly III/div_Close                Success           _34e67b'), 
    0)
