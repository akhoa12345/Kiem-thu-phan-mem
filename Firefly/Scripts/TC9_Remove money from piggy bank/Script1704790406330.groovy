...
WebUI.click(findTestObject('Object Repository/Page_Piggy banks  Firefly III/a_btn btn-default btn-xs removeMoney'))

WebUI.setText(findTestObject('Object Repository/Page_Piggy banks  Firefly III/input_amount'), '5')

WebUI.click(findTestObject('Object Repository/Page_Piggy banks  Firefly III/button_Remove'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Piggy banks  Firefly III/div_Close                Success           _46f27d'), 
    0)
