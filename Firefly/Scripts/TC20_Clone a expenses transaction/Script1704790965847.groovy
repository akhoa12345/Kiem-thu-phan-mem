...
WebUI.click(findTestObject('Object Repository/Page_All expenses between January 1st, 2024_d388e7/a_Clone'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Withdrawal Mua 1 ci bn mi  Transaction_ca184c/div_Close                Success           _621a30'), 
    0)
