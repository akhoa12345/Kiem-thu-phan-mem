...
WebUI.click(findTestObject('Object Repository/Page_Create new transfer  Transactions  Fir_53179d/a_Checking Account (-300.00)'))

WebUI.click(findTestObject('Object Repository/Page_Create new transfer  Transactions  Fir_53179d/input_destination'))

WebUI.click(findTestObject('Object Repository/Page_Create new transfer  Transactions  Fir_53179d/a_Savings Account (900.00)'))

WebUI.setText(findTestObject('Object Repository/Page_Create new transfer  Transactions  Fir_53179d/input_amount'), '500000000000000000000000000000000000000')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Create new transfer  Transactions  Fir_53179d/li_The transaction amount must be less than_a8e23d'), 
    0)
