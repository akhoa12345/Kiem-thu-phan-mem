...
WebUI.click(findTestObject('Object Repository/Page_Piggy banks  Firefly III/a_btn btn-default btn-xs'))

WebUI.setText(findTestObject('Object Repository/Page_Update piggy bank Flower  Piggy banks _674488/textarea_notes'), 'Mua 2 bông hoa')

WebUI.click(findTestObject('Object Repository/Page_Update piggy bank Flower  Piggy banks _674488/button_Update piggy bank'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Piggy banks  Firefly III/div_Close                Success           _e0df8b'), 
    0)
