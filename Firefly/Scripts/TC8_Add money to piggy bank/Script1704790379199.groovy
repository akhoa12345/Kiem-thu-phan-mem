...
WebUI.click(findTestObject('Object Repository/Page_Piggy banks  Firefly III/a_btn btn-default btn-xs addMoney'))

WebUI.setText(findTestObject('Object Repository/Page_Piggy banks  Firefly III/input_amount'), '20')

WebUI.click(findTestObject('Object Repository/Page_Piggy banks  Firefly III/button_Add'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Piggy banks  Firefly III/div_Close                Success           _0547b3'), 
    0)
